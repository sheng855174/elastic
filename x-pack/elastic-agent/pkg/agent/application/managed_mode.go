...
import (
	...
	"github.com/sheng855174/elastic/x-pack/elastic-agent/pkg/agent/application/filters"
	"github.com/sheng855174/elastic/x-pack/elastic-agent/pkg/agent/application/gateway"
	fleetgateway "github.com/sheng855174/elastic/x-pack/elastic-agent/pkg/agent/application/gateway/fleet"
	localgateway "github.com/sheng855174/elastic/x-pack/elastic-agent/pkg/agent/application/gateway/fleetserver"
	...
	"github.com/sheng855174/elastic/x-pack/elastic-agent/pkg/agent/application/pipeline/actions/handlers"
	"github.com/sheng855174/elastic/x-pack/elastic-agent/pkg/agent/application/pipeline/dispatcher"
	"github.com/sheng855174/elastic/x-pack/elastic-agent/pkg/agent/application/pipeline/emitter"
	"github.com/sheng855174/elastic/x-pack/elastic-agent/pkg/agent/application/pipeline/emitter/modifiers"
	"github.com/sheng855174/elastic/x-pack/elastic-agent/pkg/agent/application/pipeline/router"
	"github.com/sheng855174/elastic/x-pack/elastic-agent/pkg/agent/application/pipeline/stream"
	"github.com/sheng855174/elastic/x-pack/elastic-agent/pkg/agent/application/upgrade"
	...
	"github.com/sheng855174/elastic/x-pack/elastic-agent/pkg/agent/operation"
	...
	"github.com/sheng855174/elastic/x-pack/elastic-agent/pkg/capabilities"
	...
	"github.com/sheng855174/elastic/x-pack/elastic-agent/pkg/fleetapi/acker/lazy"
	"github.com/sheng855174/elastic/x-pack/elastic-agent/pkg/fleetapi/client"
	reporting "github.com/sheng855174/elastic/x-pack/elastic-agent/pkg/reporter"
	fleetreporter "github.com/sheng855174/elastic/x-pack/elastic-agent/pkg/reporter/fleet"
	logreporter "github.com/sheng855174/elastic/x-pack/elastic-agent/pkg/reporter/log"
