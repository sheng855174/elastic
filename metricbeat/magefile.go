...
import (
	...
	_ "github.com/sheng855174/elastic/dev-tools/mage/kubernetes"
	...
	// mage:import
	_ "github.com/sheng855174/elastic/dev-tools/mage/target/compose"
	// mage:import
...
func MockedTests(ctx context.Context) error {
	...
	params.ExtraFlags = []string{"github.com/sheng855174/elastic/metricbeat/mb/testing/data/."}
